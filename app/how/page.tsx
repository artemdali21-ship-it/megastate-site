...
const steps = [
  ...
  },
  {
    ...
    text: 'Анализируем и тестируем арендные ставки по каждому блоку и виду деятельности. Моделируем не менее трёх сценариев заселения, сроки выхода арендаторов на необходимый платёжный график, учитываем риски и возможные просадки. Если финмодель «не взлетает» — отказываемся.',
  },
  {
    num: '03',
