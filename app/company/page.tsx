...
const principles = [
  { num: '01', text: 'МЕГАСТЕЙТ берёт на себя обязательства и риски по подготовке объекта, заселению, управлению, ротации арендаторов.' },
  { num: '02', text: 'Все расчёты и договорённости ведутся в письменной или электронной форме.' },
  { num: '03', text: 'Договоры с собственниками и арендаторами фиксируют понятные условия.' },
  { num: '04', text: 'Долгосрочный горизонт и стабильность надёжнее и эффективнее быстрой одномоментной сделки.' },
];
      ...
      >
        <div className="split-hero">
          ...
          >
            ...
            <MotionFadeUp>
              <h1 style={{ marginBottom: '0' }}>МЕГАСТЕЙТ</h1>
              <span className="hero-line" />
              <p style={{ fontSize: '18px', color: 'var(--text-muted)', maxWidth: '480px' }}>
                Компания работает как независимый оператор объектов типа стрит-ритейл. Мы берём коммерческие помещения в долгосрочную аренду, делим на востребованные рынком части, заселяем арендаторами и ведём дальнейшее управление объектами.
              </p>
            </MotionFadeUp>
          </div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '17px', lineHeight: 1.7, marginBottom: '16px' }}>
                  ...
                  — обычно на 7–20 лет — и становится основным арендатором по
