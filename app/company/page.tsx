          ...
          >
            ...
            <MotionFadeUp>
              ...
              <p style={{ fontSize: '18px', color: 'var(--text-muted)', maxWidth: '480px' }}>
                Компания работает как независимый оператор объектов типа стрит-ритейл. Мы берём коммерческие помещения в долгосрочную аренду, делим на востребованные рынком части, заселяем арендаторами и ведём дальнейшее управление объектом.
              </p>
            </MotionFadeUp>
          </div>
